      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            Transform 100+ applications into your perfect shortlist in seconds. 
          ...
          >
            <Input 
              ...
              className="max-w-sm h-12 glass-card focus:border-primary/60 transition-all duration-300 font-medium text-foreground placeholder:text-muted-foreground" 
            />
            <Button variant="premium" size="lg" className="h-12 px-8 font-semibold">
              Join Waitlist →
            </Button>
          </motion.div>
